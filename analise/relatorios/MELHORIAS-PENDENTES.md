...
- **2026-05-06** · v4 · **P1 nova 2/4 [x]** · Cortou Seção 1 inteira (Resumo do Período) — Brief já entrega o panorama. 3 destaques duplicados sumiram junto. Brief ganhou "3 alertas críticos" que ficavam na Seção 1. Renumeração 2-10 → 1-9 + atualização das referências internas. **Pendente da P1 nova:** consolidar 3 alertas mesmo padrão + consolidar 32+ caminhos espalhados.
