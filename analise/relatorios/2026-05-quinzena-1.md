...
<svg viewBox="0 0 720 180" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:720px">
  <text x="0" y="20" font-family="Plus Jakarta Sans, sans-serif" font-size="11" fill="#8a7e72" letter-spacing="0.5">Funil da carteira ativa · etapas em sequência</text>
  <text x="720" y="20" font-family="JetBrains Mono, monospace" font-size="11" fill="#8a7e72" text-anchor="end">259 ativas</text>

  <line x1="80" y1="80" x2="480" y2="80" stroke="#d8c8a8" stroke-width="1.5"/>
<line x1="520" y1="48" x2="520" y2="112" stroke="#a89e92" stroke-width="1" stroke-dasharray="3 3"/>
<line x1="540" y1="80" x2="585" y2="80" stroke="#d8c8a8" stroke-width="1.5"/>
<circle cx="100" cy="80" r="14" fill="#a89e92" opacity="0.9"/>
<text x="100" y="84" font-family="JetBrains Mono, monospace" font-size="11" font-weight="700" fill="#fff" text-anchor="middle">10</text>
<circle cx="220" cy="80" r="26" fill="#7d96a6" opacity="0.9"/>
<text x="220" y="84" font-family="JetBrains Mono, monospace" font-size="11" font-weight="700" fill="#fff" text-anchor="middle">96</text>
<circle cx="340" cy="80" r="20" fill="#5b88a8" opacity="0.9"/>
<text x="340" y="84" font-family="JetBrains Mono, monospace" font-size="11" font-weight="700" fill="#fff" text-anchor="middle">49</text>
<circle cx="460" cy="80" r="19" fill="#3d6ea8" opacity="0.9"/>
<text x="460" y="84" font-family="JetBrains Mono, monospace" font-size="11" font-weight="700" fill="#fff" text-anchor="middle">40</text>
<circle cx="600" cy="80" r="17" fill="#b89a4a" opacity="0.9"/>
<text x="600" y="84" font-family="JetBrains Mono, monospace" font-size="11" font-weight="700" fill="#fff" text-anchor="middle">25</text>
  <text x="50" y="84" font-family="JetBrains Mono, monospace" font-size="9" fill="#8a7e72" text-anchor="middle">início</text>
<text x="500" y="84" font-family="JetBrains Mono, monospace" font-size="9" fill="#8a7e72" text-anchor="middle">fim</text>
<text x="100" y="110" font-family="Plus Jakarta Sans, sans-serif" font-size="10" font-weight="600" fill="#3a3530" text-anchor="middle">contrato</text>
<text x="100" y="122" font-family="JetBrains Mono, monospace" font-size="9" fill="#8a7e72" text-anchor="middle">3%</text>
<text x="220" y="122" font-family="Plus Jakarta Sans, sans-serif" font-size="10" font-weight="600" fill="#3a3530" text-anchor="middle">planejamento</text>
<text x="220" y="134" font-family="JetBrains Mono, monospace" font-size="9" fill="#8a7e72" text-anchor="middle">37%</text>
<text x="340" y="116" font-family="Plus Jakarta Sans, sans-serif" font-size="10" font-weight="600" fill="#3a3530" text-anchor="middle">pronto</text>
<text x="340" y="128" font-family="JetBrains Mono, monospace" font-size="9" fill="#8a7e72" text-anchor="middle">18%</text>
<text x="460" y="115" font-family="Plus Jakarta Sans, sans-serif" font-size="10" font-weight="600" fill="#3a3530" text-anchor="middle">execução</text>
<text x="460" y="127" font-family="JetBrains Mono, monospace" font-size="9" fill="#8a7e72" text-anchor="middle">15%</text>
<text x="600" y="113" font-family="Plus Jakarta Sans, sans-serif" font-size="10" font-weight="600" fill="#3a3530" text-anchor="middle">pós-obra</text>
<text x="600" y="125" font-family="JetBrains Mono, monospace" font-size="9" fill="#8a7e72" text-anchor="middle">9%</text>
<text x="80" y="160" font-family="Plus Jakarta Sans, sans-serif" font-size="10" fill="#8a7e72" font-style="italic">Fora do fluxo: 5 pausadas · 34 canceladas</text>
</svg>
</figure>

> **Amarração:** 259 ativas = 220 em fluxo (contrato → pós-obra) + 5 pausadas + 34 canceladas. Bolas proporcionais ao volume (escala suavizada por √) · maior bola = estágio de maior concentração.
